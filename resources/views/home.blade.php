            ...
            <form method="POST" action="{{route('create.user')}}" class="">
                ...
                <div class=" h-96">
                    ...
                    <div class="">
                        ...
                        <input
                            class="flex w-full h-full gap-2 px-4 border border-pink-600 rounded-tr-lg bg-slate-900 placeholder:text-white"
...
<div class="flex items-center justify-center m-2 ">
    <button id="openModal"
        class="flex items-center p-2 text-2xl font-bold text-center bg-red-400 rounded-md md:hidden font-roboto">+</button>


    <button id="openModalMD"
        class="items-center hidden p-2 text-2xl font-bold text-center bg-red-400 rounded-md md:block font-roboto">Adicionar
        usuario</button>
</div>
